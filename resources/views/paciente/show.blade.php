            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/paciente') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> IdPaciente </th><td> {{ $paciente->idPaciente }} </td></tr><tr><th> Nombre </th><td> {{ $paciente->nombre }} </td></tr><tr><th> Apellidos </th><td> {{ $paciente->apellidos }} </td></tr>
                                </tbody>
                            </table>
                        </div>
